	  ...
	  <div class="col-2">
	    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
			<div style="height: 80px;margin: 0 auto;">
							<img src="img/deplogo.jpg" alt="" style="height: 80px;object-fit: scale-down;">
						</div>
	      <a class="nav-link active" id="v-pills-home-tab" data-toggle="pill" href="./user/userList.php" role="tab" aria-controls="v-pills-home" aria-selected="true" onclick="user()"><i class="bi bi-pip" style="margin-right: 2px;"></i>账号信息</a>
	      ...
	      <a class="nav-link" id="v-pills-messages-tab" data-toggle="pill" href="#v-pills-messages" role="tab" aria-controls="v-pills-messages" aria-selected="false" onclick="allemployee()"><i class="bi bi-person-video2" style="margin-right: 2px;"></i>人员检索</a>
	 ...
	 <div class="card-body">
		...
		<div class="btn-group" style="background-color: white;">
		  ...
		  <div class="dropdown-menu dropdown-menu-right">
			...
			<?php
			if($_SESSION['depm']="yes"){
				echo '<button class="dropdown-item" type="button"><a href="./stranger/manshowemploy.php" style="color: black;">去员工页面</a></button>';
			}
			 ?>
	  ...
	  <div class="col-9">
		...
		<div style="font-size: 34px;margin-left: 20px;">寄语</div>
...
<script type="text/javascript">
  ...
  function sol(){
	  ...
	  //window.location.reload();
  	  var stand = document.getElementById('stand');
  	  stand.setAttribute("src","./solevent/showsol.php")
  }
