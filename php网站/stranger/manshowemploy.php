...
<body style="background-color: #F4F4F4;;">
	<?php require('./mansessiongetemp.php') ?>
	<!--navbar-->
	<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #cce5ff;">
	  ...
	  <div class="collapse navbar-collapse" id="navbarSupportedContent">
	    <ul class="navbar-nav mr-auto">
	      <li class="nav-item">
	        <a class="nav-link" href="subtask.php"><i class="bi bi-envelope"></i>任务提交</a>
	      </li>
	      ...
	      <li class="nav-item dropdown">
	              ...
	              <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
	                <a class="dropdown-item" href="mantdtask.php"><i class="bi bi-hourglass-split"></i>今日任务</a>
	                <a class="dropdown-item" href="mancomtask.php"><i class="bi bi-hourglass"></i>已完成任务</a>
	              </div>
	            </li>
	    </ul>
		
			<button class="btn btn-outline-success my-2 my-sm-0" type="submit"><a href="../datalist.php" style="color: #7edd6b;">回到管理员界面</a></button>
	
		
		<div class="btn-group">
		  <button type="button" class="btn btn-info">你好 <?php echo $_SESSION['user'] ?></button>
...
<?php $conn->close(); ?>	
	...
	<div class="row" style="margin: 20px 40px;">
		...
		<div class="alert alert-warning col-sm" role="alert" style="width: 25%; float: left; height: 530px;">
		  ...
		  <?php if($col5!=1&&$col6==1){
		  				  echo '<button type="button" class="btn btn-outline-warning" ><a href="manempsignout.php" style="color: #e6e600;">点击签出</a></button>';
		  }
		  else{
